...
exports.postUserRegister = exports.postUserLogin = exports.getUserByID = exports.getUserByCookie = exports.getAllUsers = void 0;
...
function postUserLogin(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, userDB, isMatch, cookie, error_3;
...
function postUserRegister(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, checkUserDB, salt, hash, userDB, cookie, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    _a = req.body, email = _a.email, password = _a.password;
                    if (!email || !password)
                        throw new Error("email or passwork missing");
                    return [4 /*yield*/, userModel_1["default"].findOne({ email: email })];
                case 1:
                    checkUserDB = _b.sent();
                    if (checkUserDB)
